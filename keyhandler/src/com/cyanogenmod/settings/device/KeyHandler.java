...
public class KeyHandler implements DeviceKeyHandler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.arg1) {
                case KEY_GESTURE_C:
                    ...
                    mContext.sendBroadcast(startIntent, Manifest.permission.STATUS_BAR_SERVICE);
                    doHapticFeedback();
                    break;
                ...
                case KEY_GESTURE_E:
                    ...
                    wakeUpAndStartIntent(startIntent);
                    break;
    ...
    private void wakeUpAndStartIntent(Intent intent) {
        mGestureWakeLock.acquire(GESTURE_WAKELOCK_DURATION);
