...
public class TouchscreenGestureSettings extends PreferenceActivity {
    ...
    private static final String KEY_AMBIENT_DISPLAY_CATEGORY = "ambient_display_key";
    ...
    private SwitchPreference mMGesturePreference;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMGesturePreference =
                (SwitchPreference) findPreference(CMActionsSettings.TOUCHSCREEN_M_GESTURE_KEY);
        mMGesturePreference.setOnPreferenceChangeListener(mGesturePrefListener);
        mWGesturePreference =
